...
```
![Motor_DC](../recursos/imgs/puente_h_sinvel.png)
...
![Motor_DC](../recursos/imgs/puente_h.png)
...
![Servo](../recursos/imgs/pwm_servo.png)
![Servo2](../recursos/imgs/esp_servo.png)

```cpp title="Control de Servo"
/*Control de 1 servo*/
#define pwm 12 //Definicion de pin de señal del servo
int duty = 0;
int grados = 0;
void setup() {
  /*Configuracion de pin PWM
...
![Servo](../recursos/imgs/esp32_pot.png)

```cpp title="Imprimir valor analogo"
const int analogPin = 34; // Pin ADC del ESP32 (GPIO 34, solo entrada)

void setup() {

  Serial.begin(115200); // mismo baudrate que el resto del curso
}
