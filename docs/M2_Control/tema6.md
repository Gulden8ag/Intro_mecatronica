...
![Recolor](../recursos/imgs/RECOLORCV.png)

**Segmentación por color (HSV + máscara):**

![Segmentación por color](../recursos/imgs/HSV.webp)
...
![Ejemplo de segmentación por color](../recursos/imgs/segment.png)
...
opening = cv2.morphologyEx(mask, cv2.MORPH_OPEN,  kernel, iterations=1)   # quita ruido pequeño
closing = cv2.morphologyEx(mask, cv2.MORPH_CLOSE, kernel, iterations=1)   # cierra huecos
```
...
![contours](../recursos/imgs/Monedas2.jpeg)
...
![Pipeline completo](../recursos/imgs/QuitarFondo.jpeg)
